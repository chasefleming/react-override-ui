(function (global, factory) {
  ...
  (global['react-override-ui'] = factory(global.React,global.PropTypes));
  ...
  var Icon = function (_Component) {
    ...
    createClass(Icon, [{
      key: 'render',
      value: function render() {
        return React__default.createElement(FontAwesomeIcon, { icon: this.props.icon });
      }
    }]);
    return Icon;
  }(React.Component);
  ...
  var DropdownItem = function DropdownItem(props) {
    if (props.options.icon) {
      return React__default.createElement(
        ...
        React__default.createElement(FontAwesomeIcon, { icon: props.options.icon, className: style.dropdownItemIcon }),
        props.options.text
      );
    } else {
      return React__default.createElement(
      ...
      value: function render() {
        ...
        if (this.props.options.type === 'iconOnly') {
          ...
          dropdownContainerContent = React__default.createElement(
            ...
            React__default.createElement(FontAwesomeIcon, { icon: this.props.options.icon })
          );
        } else {
          dropdownContainerContent = React__default.createElement(
            'span',
            ...
            ' ',
            React__default.createElement(FontAwesomeIcon, { icon: 'sort-down', className: 'icon' })
          );
        }
  ...
  library.add(_iconsCache, faHeart, faSortDown, faEllipsisV, faFolderPlus, faLink, faEye, faShareAlt, faCloudDownloadAlt, faCog, faChartLine, faQuestionCircle, faFileInvoiceDollar);
